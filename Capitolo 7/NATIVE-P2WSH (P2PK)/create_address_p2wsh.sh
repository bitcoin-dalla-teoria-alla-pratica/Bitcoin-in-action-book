...
# Witness script: <Public Key> OP_CHECKSIG
# Witness program: SHA256(witness script)
# scriptPubKey: OP_0 <witness program>

# ----- CREATE WITNESS SCRIPT ----
# Public key of https://en.bitcoin.it/wiki/BIP_0173 => 0279BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798 => address tb1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3q0sl5k7 for testing (testnet)
# PB=0279BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798
printf "\e[46m ---------- Witness Script $i --------- \e[49m\n"
PB=$(cat compressed_public_key_$i.txt)
PBLENGTH=$(char2hex.sh $(printf $PB | wc -c))
#<Public Key> OP_CHECKSIG
WITNESS_SCRIPT=$PBLENGTH$PB"AC"
...
printf  "\n\n \e[43m ######### Address P2WSH (P2PK) - Native $i #########\e[0m\n\n"
ADDRESS=$HRP"1"$MAP$MAP2
echo $ADDRESS > address_P2WSH_native_$i.txt
cat address_P2WSH_native_$i.txt

# tb1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3q0sl5k7 https://en.bitcoin.it/wiki/BIP_0173
