...
# Witness script: <OP_2><public key1><public key2><public key3> <OP_3> <OP_CHECKMULTISIG>
...
# scriptPubKey: OP_HASH160 <script hash> OP_EQUAL
  ...
  printf  "\n\e[42m ######### P2SH-P2WSH-Multisignature 2-3 #########\e[49m\n\n"
  #<OP_2><public key1><public key2><public key3> <OP_3> <OP_CHECKMULTISIG> MULTISIGNATURE 2-3
  WITNESS_SCRIPT="5221"$(cat compressed_public_key_1.txt)"21"$(cat compressed_public_key_2.txt)"21"$(cat compressed_public_key_3.txt)"53AE"
  ...
  #OP_HASH160 hash160(witness_script) OP_EQUAL
  ...
  printf $ADDR > address_p2sh_p2wsh_multisignature.txt
  printf $ADDR
