...
do
  ...
  # Witness script: P_DUP OP_HASH160 <PubKHash> OP_EQUALVERIFY OP_CHECKSIG
  ...
  printf  "\n\e[42m ######### P2SH-P2WSH-WRAP(P2PKH) #########\e[49m\n\n"
  ...
  WITNESS_SCRIPT="76a9"$PBLENGTH$PBH"88AC"
  ...
  printf $ADDR > address_p2sh_p2wsh_wrap_p2pkh.txt
  printf $ADDR
