...
#Multisig 2-3 <OP_2> <pubkey1><pubkey2><pubkey3><OP_3> <OP_CHECKMULTISIG>
...
printf  "\n\n \e[43m ######### Address P2WSH (multisignature) - Native $i #########\e[0m\n\n"
ADDRESS=$HRP"1"$MAP$MAP2
echo $ADDRESS > address_P2WSH_native_multisig.txt
cat address_P2WSH_native_multisig.txt
