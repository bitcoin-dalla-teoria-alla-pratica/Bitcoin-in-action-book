...
sh create_address_p2sh_p2wsh_wrap_p2pk.sh

#Get P2SH-P2WPKH
ADDR_P2SH_P2WSH_WRAP_P2PK=`cat address_p2sh_p2wsh_wrap_p2pk_1.txt`
ADDR_DEST=`bitcoin-cli getnewaddress "" "legacy"`

bitcoin-cli generatetoaddress 101 $ADDR_P2SH_P2WSH_WRAP_P2PK >> /dev/null
bitcoin-cli importaddress $ADDR_P2SH_P2WSH_WRAP_P2PK

#check amount
bitcoin-cli listunspent 1 101 '["'$ADDR_P2SH_P2WSH_WRAP_P2PK'"]' | jq
UTXO=`bitcoin-cli listunspent 1 101 '["'$ADDR_P2SH_P2WSH_WRAP_P2PK'"]'`

printf  "\e[43m ######### Start with P2SH-P2WSH (P2PK) transaction  #########\e[0m\n\n"
...
WITNESSCRIPT=`cat witness_script_1.txt`
...
bitcoin-cli generatetoaddress 6 $ADDR_P2SH_P2WSH_WRAP_P2PK
