...
# Witness script: OP_IF SHA256 <secret> OP_EQUAL OP_ELSE OP_SHA1 <secret> OP_EQUAL OP_ENDIF
...
SECRETSHA256=$(printf $PASS1 | openssl sha256 | awk '{print $2}')
SECRETSHA1=$(printf $PASS2 | openssl sha1 | awk '{print $2}')

SECRETSHA256_LENGTH=$(char2hex.sh $(printf  $SECRETSHA256 | wc -c))
SECRETSHA1_LENGTH=$(char2hex.sh $(printf  $SECRETSHA1 | wc -c))

# OP_IF
# 	SHA256 <password1> OP_EQUAL
# OP_ELSE
# 	OP_SHA1 <password2> OP_EQUAL
# OP_ENDIF
...
WITNESS_SCRIPT=$OP_IF$OP_SHA256$SECRETSHA256_LENGTH$SECRETSHA256$OP_EQUAL$OP_ELSE$OP_SHA1$SECRETSHA1_LENGTH$SECRETSHA1$OP_EQUAL$OP_ENDIF
