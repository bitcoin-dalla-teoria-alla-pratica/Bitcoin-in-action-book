...
# <Abdul avvocato's Sig> FALSE
WITNESS_FIELD=$(printf $SIGNATURELENGTH$SIGNATURE"00"$WITNESS_SCRIPT_LENGTH$WITNESS_SCRIPT)
...
printf "\n \e[44m ######### Moving the bitcoind time (90 days) #########\e[0m\n\n"
bitcoin-cli setmocktime $(date +%s -d 'now + 90 days')
