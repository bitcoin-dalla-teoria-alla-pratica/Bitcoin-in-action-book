...
# Witness script: OP_1 <Public Key hash> <Public Key hash> <Public Key hash> 3 OP_CHECKMULTISIG OP_3 OP_EQUAL
...
WITNESS_SCRIPT="5121"$(cat compressed_public_key_1.txt)"21"$(cat compressed_public_key_2.txt)"21"$(cat compressed_public_key_3.txt)"53AF5387"
